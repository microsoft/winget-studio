...
public sealed partial class DSCSetUnitOperation : IOperation<DSCOperationResult<IDSCApplyUnitResult>>
{
    ...
    public DSCSetUnitOperation(ILogger logger, IStringLocalizer localizer, IDSC dsc, IDSCFile dscFile)
    {
        _logger = logger;
    ...
    /// <summary>
    /// Executes the DSC set unit operation.
    /// </summary>
    /// <param name="context">The operation context.</param>
    /// <returns>The DSC set unit result.</returns>
